        ...
        {reviews.map((review) => (
          <li key={review.id}>
            ...
            <p className="text-xs text-gray-500 mt-1">
              {/* Display the date, which is now a Date object */}
